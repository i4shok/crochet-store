...
function Navbar() {
  ...
  const [hideNavActions, setHideNavActions] = useState(false);
  ...
  return (
    <header className={`navbar ${isScrolled ? "navbar-scrolled" : ""} ${hideNavActions ? "nav-hidden" : ""}`}>
